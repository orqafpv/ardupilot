# Orqa H7 QuadCore Flight Controller

The Orqa H7 QuadCore is a flight controller produced by [Orqa](https://enterprise.orqafpv.com/).
...
![Orqa H7 QuadCore Board](OrqaH7 QuadCore_Board.png "Orqa FC 3030 H743")
...
The Orqa H7 QuadCore supports OSD using OSD_TYPE 1 (MAX7456 driver) or OSD_TYPE 3 if using DJI OSD

## PWM Output

The Orqa H7 QuadCore supports up to 10 PWM outputs in the JST-GH ESC and MFC connectors and Servo pads.
...
The Orqa H7 QuadCore does not have a builtin compass, but you can attach an external compass using I2C on the SDA and SCL pin.
